...
tweets = api.user_timeline(screen_name='osama_amaso',
...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"]="/Users/rzhan/Desktop/Alzheimer\'s-683341b411e6.json"

client = vision.ImageAnnotatorClient()

file = open('Label_Detection.json', 'w')
...
posts = db.posts
with open('Label_Detection.json') as json_file:  
